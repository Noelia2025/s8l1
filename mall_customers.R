...
# Ver las primeras filas para comprobar que se ha cargado correctamente
head(dataset)

# 2. Exploración de datos
str(dataset)  # Estructura de los datos
...
# Normalización de las variables numéricas (Ingreso Anual y Puntuación de Gasto)
...
# Agregar los resultados al dataset original
...
# Análisis descriptivo para los clusters jerárquicos
aggregate(dataset[, c("Age", "Annual_Income", "Spending_Score")],
          by = list(Cluster_Hierarchical = dataset$Cluster_Hierarchical),
          FUN = mean)
